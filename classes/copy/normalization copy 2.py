...
class AudioProcessor:
    ...
    def process_file(self, filename):
        ...
        if file_ext.lower() != ".wav":
            ...
            print(f"Converting {filename} to WAV format as {new_file_name}")
        else:
        ...
        print(f"Processed and saved {filename} as {new_file_name}")

        return new_file_name  # Return just the file name
